    ...
    <body>
        ...
        <div class="container result">
           ...
           <div class="row"> 
                  ...
                  <div class="col-xs-6 col-sm-3 col-lg-3"> 
                     <a href="index34.php" class='btn btn-success'>Start new Quiz!!!</a>                   
                     <a href="logout1.php" class='btn btn-success'>Logout</a>
                       ...
                       <div style="margin-top: 30%">
						...
						<P> Grade : <span class="answer"> <?php echo "<b>$grade"; ?> </span> </p>
						<p> Your Score : <span class="answer"> <?php echo "<b> $right_answer"; ?> </span> </p>
                       </div> 
        ...
        <footer>
            <p class="text-center" id="foot">
                &copy; <a href="http://www.gpkolhapur.org.net/" target="_blank">GPKP </a>2016
            </p>
        </footer>
